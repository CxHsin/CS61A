...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    max_num_roll = 1
    for i in range(1, 11):
        make_score = make_averaged(roll_dice, samples_count)(i, dice)
        if (make_score > max_score):
            max_score = make_score
            max_num_roll = i
    return max_num_roll
    # END PROBLEM 9
