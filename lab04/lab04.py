...
def closer_city(lat, lon, city_a, city_b):
    ...
    city_a_distance = distance(city, city_a)
    city_b_distance = distance(city, city_b)
    return get_name(city_b) if city_b_distance <= city_a_distance else get_name(city_a)
